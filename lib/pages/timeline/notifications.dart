...
//             switch (value) {
//               case 'clear':
//                 DialogUtils.showSimpleAlertDialog(context: context,text: S.of(context).are_you_sure_you_want_to_delete_the_message_list_forever,onConfirm: _clearNotification);
//                 break;
//               case 'choose_type':
