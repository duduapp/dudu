...
class _SettingContentState extends State<SettingContent> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: Text(S.of(context).display_setting),),
      body: ListView(
        children: [
          ...
          ProviderSettingCell(
            ...
            options: ['0', '1'],
            displayOptions: [S.of(context).currently_showing_likes, S.of(context).currently_showing_favorites],
