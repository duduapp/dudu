...
//                                 ]),
//                                 TableRow(children: [
//                                   Text(S.of(context).user_number, style: TextStyle(fontSize: 16)),
//                                   Text(instance.stats['user_count'].toString())
//                                 ]),
//                                 TableRow(children: [
//                                   Text(S.of(context).number_of_toots, style: TextStyle(fontSize: 16)),
//                                   Text(
//                                       instance.stats['status_count'].toString())
//                                 ]),
//                                 TableRow(children: [
//                                   Text(S.of(context).version, style: TextStyle(fontSize: 16)),
//                                   Text(
//                                       instance.version)
//                                 ])
//                               ],
...
//                   children: [
//                     FlatButton(onPressed: () => AppNavigate.push(PublicTimeline(url: instance.uri,)), child: Text(S.of(context).browse_to_see)),
//                     FlatButton(onPressed: () {}, child: Text(S.of(context).log_in)),
//                   ],
//                 ),
//               )
//             ],
