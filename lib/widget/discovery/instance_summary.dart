...
class InstanceSummary extends StatelessWidget {
  ...
  final bool
      restrictedMode; // can not register,can not view federated timeline, can not open timeline

  InstanceSummary(this.item,
      {this.showAction = true, this.onDelete, this.restrictedMode = true});
                    ...
                    Padding(
                      ...
                      child: Text(
                        StringUtil.removeAllHtmlTags(
                            item.detail.description.isEmpty
                      ...
                      Container(
                        child: Row(
                          ...
                          children: [
                            TextInkWellV2(
                              onTap: () async {
                                await InstanceManager.login(item.detail);
                              },
                            ...
                            TextInkWellV2(
                              onTap: restrictedMode
                                  ? () {}
                                  : () {
                                      UrlUtil.openUrl('https://' +
                                          urlWithoutHttpPrefix +
                                          '/auth/sign_up');
                                    },
                            ...
                            TextInkWellV2(
                              onTap: () {
                                AppNavigate.push(InnerBrowser('https://' +
                                    urlWithoutHttpPrefix +
                                    '/about/more'));
                              },
